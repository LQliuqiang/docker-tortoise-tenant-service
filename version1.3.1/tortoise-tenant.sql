...
CREATE TABLE `department` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `departmentName_tenantId` (`department_name`,`tenant_id`)
...
CREATE TABLE `permission` (
  ...
  `update_date` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `permissionTag` (`permission_tag`)
...
CREATE TABLE `role` (
  ...
  `update_date` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `roleTag_tenantId` (`role_tag`,`tenant_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tenant_info` (
  ...
  `update_date` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `tenantName` (`tenant_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tenant_info
-- ----------------------------
INSERT INTO `tenant_info` VALUES ('781ad5d4c3f544ea8508e7371b4ce154', 'tortoise', 'awl/VrVsF0ZQcgxbdqloxw==', 'null', '1342685000@qq.com', 'Fii', '1', '1', '/file/responseImg?fileName=tenant_head.jpg', 'null', '2020-05-13 16:09:39', '2020-07-02 08:57:17');
...
CREATE TABLE `user_info` (
  ...
  KEY `tenantId_duty` (`tenant_id`,`duty`),
  KEY `tenantId_company` (`tenant_id`,`company`),
  KEY `tenantId_departmentId` (`tenant_id`,`department_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;